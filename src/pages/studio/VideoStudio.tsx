...
import { 
  ...
  Video, VideoOff, CircleDot, Square, Play, Pause
} from "lucide-react";
import { cn } from "@/lib/utils";

type ScenePreset = "host-only" | "side-by-side" | "speaker-switch";

const scenePresets: { id: ScenePreset; label: string; desc: string }[] = [
  { id: "host-only", label: "Host Only", desc: "Single camera view" },
  { id: "side-by-side", label: "Side-by-Side", desc: "Equal split layout" },
  { id: "speaker-switch", label: "Speaker Switch", desc: "Auto-switch to active speaker" },
];
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 flex flex-col p-4 lg:p-6">
          <div className={cn(
            ...
            {guestJoined && (
              <div className="absolute bottom-4 right-4 w-32 h-24 rounded-lg bg-black/60 border border-white/20 flex items-center justify-center">
          ...
          <div className="mt-4 flex items-center justify-center gap-4">
            ...
            <Button
              ...
              className={cn("w-12 h-12 rounded-full", isMuted ? "bg-red-500/20 text-red-400" : "bg-white/10 text-white")}
            >
            ...
            <Button
              ...
              className={cn("w-12 h-12 rounded-full", isVideoOff ? "bg-red-500/20 text-red-400" : "bg-white/10 text-white")}
            >
        ...
        <aside className="w-72 border-l border-white/10 flex flex-col hidden lg:flex">
          <Tabs value={rightTab} onValueChange={setRightTab} className="flex-1 flex flex-col">
            <TabsList className="bg-transparent border-b border-white/10 rounded-none h-12 p-0">
              ...
              <TabsTrigger value="clips" className="flex-1 rounded-none border-b-2 border-transparent data-[state=active]:border-white data-[state=active]:bg-transparent text-white/60 data-[state=active]:text-white">
            ...
            <TabsContent value="scripts" className="flex-1 p-4 m-0">
              <div className="h-full flex flex-col items-center justify-center text-center">
                ...
                <p className="text-xs text-white/40">Add from Templates</p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="clips" className="flex-1 p-4 m-0">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-violet-500/20 text-violet-400 border-0">{autoClips.length}</Badge>
                </div>
                {autoClips.length === 0 ? (
