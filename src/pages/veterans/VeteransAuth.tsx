...
export default function VeteransAuth() {
    ...
    try {
      ...
      const { data, error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          data: {
            full_name: name,
            account_type: 'veteran', // Mark as veteran account
          }
        }
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <Helmet>
        <title>Sign In | Veterans Benefits Hub</title>
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-12 max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardTitle>Welcome to Veterans Benefits Hub</CardTitle>
            <CardDescription>
              Create an account to save your calculations and conversation history
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <p className="mt-1">Free forever • No credit card required</p>
            </div>
          </CardContent>
        </Card>
      </div>
